		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"> SOF <span>TEL</span><p class="logo_w3l_agile_caption">Tu Cadena de Hoteles</p></a></h1>
				</div>
	...
	<div id="home" class="w3ls-banner">
		...
		<div class="slider">
			<div class="callbacks_container">
				...
				<a href="#" class="menu__link" data-toggle="modal" data-rel="dialog" data-target="#myModal">leer más
</a>
			</div>
								</div>
							</div>
...
:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Teléfono :</strong>5555555</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="#">softel@support.site</a></p>
			<p class="contact-agile1"><strong>Direccion :</strong>Uniminuto</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2018  <a href="index.php">SOFTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
