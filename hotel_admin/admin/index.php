...
<body>
  <div id="clouds">
	...
	<div class="bottom">  <h3><a href="../index.php">SOFTEL HOMEPAGE</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = mysqli_real_escape_string($conexion,$_POST['user']);
      $mypassword = mysqli_real_escape_string($conexion,$_POST['pass']);

      $sql = "SELECT user FROM empleados WHERE user = '$myusername' and pass = '$mypassword'";
